...
public class PoisonRun : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            InventoryMiniUI MiniInventory1 = other.GetComponent<InventoryMiniUI>();
            MiniInventory1.Poison_SpeedCurrent ++;
            MiniInventory1.anim.Play("CurrentMiniInv");
            
            PlayerPrefs.SetInt("Poison_Run", +1);
            PlayerPrefs.Save();
        }
    }
}
