...
public class PoisonScriptRegen : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            InventoryMiniUI MiniInventory3 = other.GetComponent<InventoryMiniUI>();
            MiniInventory3.Poison_RegenCurrent ++;
            MiniInventory3.anim.Play("CurrentMiniInv");
            
            PlayerPrefs.SetInt("Poison_Regen", +1);
            PlayerPrefs.Save();
        }
    }
